...
<html lang="en">
  <head>
    <title>Receptionist's home</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <nav class="navbar navbar-expand-sm navbar-dark" style="background-color: black;">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavId">
        ...
        <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="dropdownId" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Patients</a>
                <div class="dropdown-menu" aria-labelledby="dropdownId">
                    <a class="dropdown-item" href="registerpatient.php">Register Patients</a>
                    <a class="dropdown-item" href="viewpatients.php">View Patients list</a>
                </div>
            </li>
            
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="dropdownId" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Appointments</a>
                <div class="dropdown-menu" aria-labelledby="dropdownId">
